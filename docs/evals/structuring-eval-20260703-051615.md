# Structuring eval — 2026-07-03 05.16
...
- Items: 9; repetitions: 3; temperature: 0; max output tokens: 512; reasoning off (API-level think=false): True
...
| latency mean | 1366 ms | 850 ms |
| latency p50 | 664 ms | 597 ms |
| latency max | 5544 ms | 7277 ms |

...
using FeedbackIntelligence.StructuringEval;
...
try
{
    switch (args.FirstOrDefault()?.ToLowerInvariant())
    {
        ...
        default:
            Console.WriteLine("""
                FeedbackIntelligence.StructuringEval — Phase 0 spike + structuring-model eval

                Usage (from the repo root):
                  dotnet run --project tools/FeedbackIntelligence.StructuringEval -- ping
                  dotnet run --project tools/FeedbackIntelligence.StructuringEval -- eval
